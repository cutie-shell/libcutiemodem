...
{
	QDBusInterface("org.mobian_project.CallAudio",
...
{
	QDBusReply<QDBusVariant> audioModeReply =
		QDBusInterface("org.mobian_project.CallAudio",
			       "/org/mobian_project/CallAudio",
			       "org.freedesktop.DBus.Properties",
			       QDBusConnection::sessionBus())
			.call("Get", "org.mobian_project.CallAudio",
			      "AudioMode");
	m_audioMode =
		audioModeReply.isValid() ?
	...
	QDBusConnection::sessionBus().connect(
		...
		SLOT(onCallAudioPropertiesChanged(
			QString, QMap<QString, QVariant>, QStringList)));
}

void CutieModemPrivate::onCallAudioPropertiesChanged(
